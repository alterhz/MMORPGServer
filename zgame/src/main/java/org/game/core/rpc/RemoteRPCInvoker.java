...
public class RemoteRPCInvoker implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        try {
            ...
            logger.error("Failed to serialize RPC request = {}", request, e);
    ...
    private void parseRPCRequest(String jsonRequest) {
        ...
        try {
            request = objectMapper.readValue(jsonRequest, RPCRequest.class);
            logger.debug("Deserialized request : {}", request);
        } catch (Exception e) {
            logger.error("Failed to deserialize RPC request: {}", jsonRequest, e);
